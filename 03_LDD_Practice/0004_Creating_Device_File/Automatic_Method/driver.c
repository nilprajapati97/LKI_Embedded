...
static int __init hello_world_init(void)
{
        ...
        if((dev_class = class_create(THIS_MODULE,"Infinite_class")) == NULL){
            pr_err("Cannot create the struct class for device\n");
            goto r_class;
        }
 
        /*Creating device*/
        if((device_create(dev_class,NULL,dev,NULL,"Infinite_device")) == NULL){
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR(" Nil Prajapati < nil.prajapati@yahoo.com >");
